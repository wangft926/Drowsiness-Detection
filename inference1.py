...
while True:
    ...
    if len(prediction_list) > 5:
        if (prediction_list[-1] == prediction_list[-2]) and (prediction_list[-1] == prediction_list[-3])and (prediction_list[-1] == prediction_list[-4])and (prediction_list[-1] == prediction_list[-5]):
