...
def preprocess_data(config):
    ...
    print("------------Norm params:\n", norm_params)
    np.save("preprocess_window_bianji.npy", windows_arr)
    np.save("preprocess_label_bianji.npy", labels_array)
    np.save("preprocess_face_windows_bianji.npy", all_face_windows)
